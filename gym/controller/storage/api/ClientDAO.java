...
public interface ClientDAO extends DAO<Client, Long> {
    ...
    List<Client> findBirthdayPerson() throws GymException;

    Client changeMembership(Client client, Membership membership) throws GymException;

    Date showExpirationDate(Client client) throws GymException;
}
